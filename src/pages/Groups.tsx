...
import { Search, Users, Plus, Lock, Globe, UserPlus } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              >
                <Plus size={16} className="mr-2" /> Створити групу
              </button>
            </div>
            ...
            {groups.length === 0 ? (
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-gray-500">
                  {searchQuery ? 'Спробуйте змінити пошуковий запит' : 'Створіть першу групу або приєднайтеся до існуючої'}
                </p>
              </div>
            ) : (
              groups.map((group) => (
                  ...
                  >
                    <div className="flex items-start space-x-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        {group.description && <p className="text-sm text-gray-700 line-clamp-2">{group.description}</p>}
                      </div>
                    </div>
                  </div>
